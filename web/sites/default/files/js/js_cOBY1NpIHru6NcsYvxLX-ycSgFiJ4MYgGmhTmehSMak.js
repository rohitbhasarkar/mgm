...
//     attach: function (context, settings) {
//       $('#calculate_result').click(function (event) {
//         let numOne, numTwo, operation, result;
//         numOne = Number($('#edit-value-one').val());
//         numTwo = Number($('#edit-value-two').val());
//         operation = $('#edit-operation').val();
//
//         console.log('vvvvvvvvvvNum 2:' + $('#edit-value-one'));
//         switch (operation) {
//           case 'add':
...
(function ($, Drupal, drupalSettings) {
  var content = '<div><p id="version-confirm-form-text">If you need to simple js pop up wihtout any server side call use this method</p>';
  content = content + '<input class="button--primary click-trig-submit  button"  type="button" name="op" value="Create new"><input title="cancel"  class=" cancel_mod  button"  type="button"  name="op" value="Cancel"></div>';
